...
class Test(unittest.TestCase):
    ...
    def test_checkTriangle_2(self):
        self.assertEquals(detect_triangle(10**-9, 6, 7),"Khong la tam giac")
    def test_checkTriangle_3(self):
        self.assertEquals(detect_triangle(2**31 -1, 6, 7),"Khong la tam giac")
    ...
    def test_checkTriangle_18(self):
        self.assertEquals(detect_triangle(3,1,3),"Tam giac can")
    def test_checkTriangle_19(self):
        self.assertEquals(detect_triangle(1,3,3),"Tam giac can")
    ...
    def test_checkTriangle_21(self):
        self.assertEquals(detect_triangle(2**32 -1, 0.1, 2**32 -1),"Tam giac can")
